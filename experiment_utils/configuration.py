...
args_path = f'C:/Users/owner/Janis Lab Code repos/{user}/janis-lab-opx+/experiment_utils/'
...
qubit_freq = qubit_args['qubit_freq_sweet_spot'] if sweet_spot_flag else qubit_args['qubit_freq_zero_bias']
...
mixer_qubit_g = -0.03566545454545449 #  0.026705454545454553  # 0.009018181818181828  # 0.2054400000000001
mixer_qubit_phi = -0.24667636363636358 # 0.07806545454545451  # 0.05301818181818182  # 0.19518545454545452
...
config = {
    ...
    "waveforms": {
        ...
        "I_gaussian_wf": {"type": "arbitrary",
                          "samples": generate_gaussian_pulse(amplitude=saturation_amp, length=saturation_len,
                                                             sigma=0.02)},
        ...
        "rampup_I_wf": {"type": "arbitrary", "samples": np.linspace(0, 0.5, square180_len).tolist()},
        # this is redefined in experiment script
        "rampup_Q_wf": {"type": "arbitrary", "samples": np.zeros(square180_len).tolist()},
        # this is redefined in experiment script
        "rampdown_I_wf": {"type": "arbitrary", "samples": np.linspace(0.5, 0, square180_len).tolist()},
        # this is redefined in experiment script
        "rampdown_Q_wf": {"type": "arbitrary", "samples": np.zeros(square180_len).tolist()},
        # this is redefined in experiment script
    },
